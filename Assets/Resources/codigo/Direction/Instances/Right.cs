...
public class Right : ADirection
{
    public static Right Instance
    {
        get
        {
            if (FindObjectOfType<Right>())
            {
                return FindObjectOfType<Right>();
            }
            else
            {
                var new_instance = new GameObject().AddComponent<Right>();
    ...
    {
        if (!square) { return null; }
        return square.Up_right(number_left, number_forward);
    }
    ...
    {
        if (!square) { return null; }
        return square.Down_right(number_right, number_forward);
    }
    ...
    {
        if (!square) { return null; }
        return square.Up_left(number_left, number_back);
    }
    ...
    {
        if (!square) { return null; }
        return square.Down_left(number_right, number_back);
    }
